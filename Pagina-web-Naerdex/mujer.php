...
<head>
    ...
    <title>Mujer | Naerdex</title>
    <meta name="description" content="Colección de calzado femenino Naerdex. Sneakers, botas y calzado deportivo con estilo y comodidad para mujer.">
    <meta property="og:title" content="Mujer | Naerdex">
    <meta property="og:description" content="Colección de calzado femenino Naerdex. Sneakers, botas y calzado deportivo.">
    ...
    <meta property="og:url" content="https://naerdex.com/mujer.php">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Mujer | Naerdex">
    <meta name="twitter:description" content="Colección de calzado femenino Naerdex. Sneakers, botas y calzado deportivo con estilo y comodidad para mujer.">
    ...
    <link rel="canonical" href="https://naerdex.com/mujer.php">
...
<?php $currentPage = 'mujer'; include 'includes/header.php'; ?>

    <section class="page-hero page-hero-women">
        <div class="hero-content fade-in">
            <span class="hero-subtitle">Colección Femenina</span>
            <h1 class="hero-title">Estilo que Inspira</h1>
            <p class="hero-description">Calzado con carácter, diseñado para mujeres que marcan la diferencia.</p>
        </div>
    </section>
    ...
    <main class="container shop-section">
        <div class="shop-header">
            <div>
                <h2 class="section-title">Mujer</h2>
